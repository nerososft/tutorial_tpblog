        ...
        <div class="col-md-10">
            <div class="col-md-3" style="background:rgb(245,247,249)">
                <div class="col-md-12" style="background:#fff;padding:0px;">
                    <div class="col-md-12" style="background:#333;color:#fff;padding-top:1em;height:8em;">
            ...
            <div class="col-md-9" style="background:#fff;padding-top:5em;">
                ...
                <div class="col-md-12" id="article_container" style="padding: 0;margin: 0;">
                    <div class="col-md-12" style="padding:0;padding-top:1em">
                        <p class="col-md-12" style="padding:0;text-align: center;">目前共计5个分类</p>
                        <p id="categories_container" class="col-md-12" style="padding: 0;padding-top: 1em;padding-left: 2em;padding-right: 2em;">
                           
                        </p>
                        <p class="col-md-12" style="padding: 0;margin: 0;margin-top:1em;margin-left: 1em;">热评文章</p>
                        <ul class="col-md-12" style="padding: 0;margin: 0;margin-top: 2em;padding-left: 2em;padding-bottom: 3em;">
                            <li class="col-md-12" style="padding:0;margin:0;padding-left: 0em;color: #888;text-decoration: underline;">《数学之美》书摘之自然语言处理(一)</li>
                        </ul>
                    </div>
                </div>
...
<script src="/blog/Public/Static/js/categories.js"></script>
<script>
    //$.ready(function(){
    user.Operate.getBaseInfo();
    categories.Operate.getC();
    //});
</script>
</html>